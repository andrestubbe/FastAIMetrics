...
cd /d "%~dp0"
echo ===================================================
echo  Building FastAIMetrics & Running Live Demo
echo ===================================================
